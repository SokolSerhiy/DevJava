...
public class Main {
	...
	public static void main(String[] args) {
		...
		// map.put("Engineer", new Person("Mykola", 25, Gender.MALE));
		...
		// map.get("Engineer").add(new Person("Mykola", 25, Gender.MALE));
		...
		while (true) {
			...
			System.out.println("Enter 4 to show by proffesion");
			System.out.println("Enter 5 to merge two proffesion");
			switch (sc.next()) {
			case "1":
			...
			case "4":
				...
				break;
			case "5":
				System.out.println("Enter proffesion for add");
