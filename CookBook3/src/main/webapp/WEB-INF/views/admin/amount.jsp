		...
		<div class="container-fluid">
			...
			<div class="collapse navbar-collapse" id="myNavbar">
				<ul class="nav navbar-nav">
					...
					<li class="active"><a href="/admin/amount<custom:allParams/>">Amount</a></li>
		...
		<div class="row">
			<div class="col-md-12 col-xs-12">
				<form:form class="form-horizontal" action="/admin/amount" method="POST" modelAttribute="amount">
					...
					<div class="form-group">
						<label for="ingredient" style="color:red;text-align:left;" class="col-sm-10 col-sm-offset-2 control-label"><form:errors path="ingredient"/></label>
					</div>
					<div class="form-group">
  					...
  					<div class="form-group">
						<label for="amount" style="color:red;text-align:left;" class="col-sm-10 col-sm-offset-2 control-label"><form:errors path="amount"/></label>
					</div>
					<div class="form-group">
  					...
  					<div class="form-group">
    					...
    					<div class="col-sm-10">
      						<form:select class="form-control" path="system" id="ms" items="${measuringSystems}" itemValue="id" itemLabel="name"/>
    					</div>
  					</div>
  					<div class="form-group">
					...
					<div class="col-md-6 col-xs-6 text-center">
						<div class="dropdown">
							...
							<ul class="dropdown-menu">
								...
								<custom:sort innerHtml="System name asc" paramValue="system.name" />
								<custom:sort innerHtml="System name desc" paramValue="system.name,desc" />
							</ul>
						</div>
					</div>
					<div class="col-md-6 col-xs-6 text-center">
