...
public class SpendResourcesValidator implements Validator{
	...
	public SpendResourcesValidator(int min, int max, String resName, String methodName, Validator validator) {
		this.min = min;
		this.max = max;
